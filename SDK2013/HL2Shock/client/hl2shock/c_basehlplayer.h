...
public:
	...
	//SHOCK
	CNetworkVar(int, m_intHealthHypoStock);
...
public:
	...
	// Shock
	//int m_intHealthHypoStock; // We'll use this later
...
inline C_BaseHLPlayer* To_BaseHLPlayer(CBaseEntity *pEntity)
{
	if (!pEntity)
		return NULL;
	Assert(dynamic_cast< C_BaseHLPlayer* >(pEntity) != NULL);
