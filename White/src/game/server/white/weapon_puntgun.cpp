...
ConVar physcannon_tracelength( "puntgun_tracelength", "480", FCVAR_CHEAT ); //250 1500 485 488 592
...
ConVar player_throwforce( "player_throwforce", "5000", FCVAR_CHEAT ); //1000
...
#define PUNTGUN_BEAM_SPRITE "sprites/puntgun/shockbolt2.vmt" // Shock beam
#define PUNTGUN_CENTER_GLOW "sprites/glow04.vmt" // Barrel Effects
#define PUNTGUN_BLAST_SPRITE "sprites/glow04.vmt" // Barrel Effects - When ATTACK2 is held down
...
//	if ( nModelType == mod_brush || tr.surface.flags & SURF_NOPORTAL )
	if ( FClassnameIs( pEntity, "func_punt_surface" ) || FClassnameIs( pEntity, "prop_dynamic" ) )
	{
		CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
		Vector backward;
